...
/**
 * Computes the number of variant objects associated with genes that are candidate or solved that are available for
 * matching using MME in this node. This includes duplicates.
 *
 * @version $Id$
 */
@Component
@Named("numberOfVariants")
@Singleton
public class NumberOfVariantsProvider implements MetricProvider
{
    @Inject

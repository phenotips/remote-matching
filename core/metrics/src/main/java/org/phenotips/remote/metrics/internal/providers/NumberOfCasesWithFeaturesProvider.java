...
/**
 * Computes the number of cases which have phenotypes or prenatal phenotypes.
 *
 * @version $Id$
 */
@Component
@Named("numberOfFeatureSets")
@Singleton
public class NumberOfCasesWithFeaturesProvider implements MetricProvider
{
    @Inject

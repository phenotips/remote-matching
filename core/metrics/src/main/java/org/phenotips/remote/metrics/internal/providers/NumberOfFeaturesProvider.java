...
/**
 * Computes the number of HPO codes in the 'phenotype' and 'prenatal phenotype' fields.
 *
 * @version $Id$
 */
@Component
@Named("numberOfFeatures")
@Singleton
public class NumberOfFeaturesProvider implements MetricProvider
{
    @Inject
    ...
    public Object compute()
    {
        ...
        try {
            ...
            Query q = session.createQuery("select count (elements(prop.list)) from "

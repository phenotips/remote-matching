...
/**
 * Computes the number of rows from raw incoming requests request table.
 *
 * @version $Id$
 */
@Component
...
public class NumberOfRequestsReceivedProvider implements MetricProvider
{
    ...
    public Object compute()
    {
        ...
        try {
            ...
            Query q = session.createQuery("select count (req)"
                + " from DefaultIncomingMatchRequest as req");
